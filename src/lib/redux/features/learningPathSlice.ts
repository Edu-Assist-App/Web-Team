...
const learningPathsSlice = createSlice({
  ...
  reducers: {
    setActiveLearningPath: (
      state,
      action: PayloadAction<LearningPath | null>
    ) => {
  ...
  extraReducers: (builder) => {
    ...
    builder.addMatcher(
      learningPathsApi.endpoints.getLearningPathById.matchFulfilled,
      (state, { payload }) => {
    ...
    builder.addMatcher(
      learningPathsApi.endpoints.getLearningPathSteps.matchFulfilled,
      (state, { payload }) => {
