...
export function FileUploadModal({ isOpen, onClose, onAddFiles }: FileUploadModalProps) {
      ...
      <div className="bg-white rounded-lg max-w-lg w-full max-h-[90vh] overflow-auto">
        ...
        <div className="p-4">
          ...
          >
            ...
            <p className="text-gray-500 text-xs mt-2">PDF, DOCX, TXT, PPT files (max 10MB each)</p>
          </div>
                ...
                {files.map((file, index) => (
                  <div key={index} className="flex items-center justify-between bg-gray-50 p-2 rounded">
                    <div className="flex items-center">
                      ...
                      <div>
                        <p className="text-sm truncate max-w-[200px] md:max-w-[300px]">{file.name}</p>
